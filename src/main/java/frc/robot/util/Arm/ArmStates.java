...
public class ArmStates {
    public static final ArmState stowGeneric = new ArmState("Unused State", 80, 70, 600).makeStow();
    ...
    public static final ArmState stowForHandoff = new ArmState("Stow For Handoff", 10, 10, 600).makeStow();
    ...
    public static final ArmState getConeFromShelf = new ArmState("Get Cone From Shelf", 85.3, 34, 300);
    public static final ArmState getCubeFromShelf = new ArmState("Get Cube From Shelf", 77.6, 31.7, 300);
    public static final ArmState getConeFromChute = new ArmState("Get Cone From Chute", 85.3, 34, 300).addDeployIntermediaries(1).addRetractIntermediaries(1);
    public static final ArmState getCubeFromChute = new ArmState("Get Cube From Chute", 85.3, 34, 300).addDeployIntermediaries(1).addRetractIntermediaries(1);
